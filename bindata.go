...
func bashenvBashBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "bashenv/bash.bash", size: 557, mode: os.FileMode(420), modTime: time.Unix(1498146551, 0)}
...
func bashenvCmdBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "bashenv/cmd.bash", size: 1479, mode: os.FileMode(420), modTime: time.Unix(1498146551, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bashenvFnBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "bashenv/fn.bash", size: 547, mode: os.FileMode(420), modTime: time.Unix(1498146551, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bashenvPlugnBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "bashenv/plugn.bash", size: 4605, mode: os.FileMode(420), modTime: time.Unix(1498146551, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
